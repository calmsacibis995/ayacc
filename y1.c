...
void aryfil( v, n, c ) int *v,n,c; { /* set elements 0 through n-1 to c */
	int i;
	for( i=0; i<n; ++i ) v[i] = c;
	}
...
int setunion(a, b) int register *a, *b; {
	/* set a to the union of a and b */
	/* return 1 if b is not a subset of a, 0 otherwise */
	int register i, x, sub;
...
int cpfir() {
	...
	int register *p, **s, i, **t, ch, changes;
...
int state(c) /* sorts last state,and sees if it equals earlier ones. returns state number */
{
	int size1,size2;
	int register i;
...
int closure(i) /* generate the closure of state i */
{
...
int main(int argc, char *argv[]) {
	...
	setup(argc,argv); /* initialize and read productions */ /* is located in y2.c */
